  ...
  return regeneratorRuntime.async(function main$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 18:
          _context.next = 20;
          return regeneratorRuntime.awrap(gateway.getNetwork('channelall'));

        case 20:
          network = _context.sent;
          // Get the contract from the network.
          contract = network.getContract('fabcar1'); // Submit the specified transaction.
          // createCar transaction - requires 5 argument, ex: ('createCar', 'CAR12', 'Honda', 'Accord', 'Black', 'Tom')
          // changeCarOwner transaction - requires 2 args , ex: ('changeCarOwner', 'CAR12', 'Dave')

          _context.next = 24;
          return regeneratorRuntime.awrap(contract.submitTransaction('createCar', 'CAR15', 'Lamborghini', 'Accord', 'Black', 'Sithu'));
