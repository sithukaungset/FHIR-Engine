...
async function main() {
    try {
        ...
        const account = prompt('Account ID : ');

        console.time("TimeTaken");
        const transaction = contract.createTransaction('deleteAccount');
        const result = await transaction.submit(account);
        console.log('Document has been deleted.', result.toString());
