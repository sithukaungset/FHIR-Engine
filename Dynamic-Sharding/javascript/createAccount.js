...
async function main() {
    try {
        ...
        const accountNumber = await prompt('Accout Number : ');
        const customerID = await prompt('Customer ID : ');
        const checkingBalance = await prompt('Checking Balance : ');
        const customName = await prompt('Customer Name : ');

        console.time("TimeTaken");
        await contract.submitTransaction('createAccount', accountNumber, customerID, checkingBalance, customName);
