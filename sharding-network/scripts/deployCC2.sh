...
if [ "$CC_SRC_LANGUAGE" = "go" ]; then
  ...
  CC_SRC_PATH1=$CC_SRC_PATH/build/install/$CC_NAME
...
checkCommitReadiness 1 "\"Org1MSP\": true" "\"Org4MSP\": false"
checkCommitReadiness 4 "\"Org1MSP\": true" "\"Org4MSP\": false"
