...
app.post('/api/create/',  urlencodedParser, async function(req, res){
    try{
        ...
        // queryCar transaction - requires 1 argument, ex: ('queryCar', 'CAR4')
        // queryAllCars transaction - requires no arguments, ex: ('queryAllCars')
        await contract.submitTransaction('createEHR',req.body.EHRNumber,req.body.patientID,req.body.DateTime, req.body.Organization,req.body.patientName,req.body.Function, req.body.data);
